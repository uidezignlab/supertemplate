    ...
    UI.component('lightbox', {
        ...
        fitSize: function() {
            ...
            if (this.siblings.length > 1) {
                ...
                content = [
                    content,
                    '<a href="#" class="uk-slidenav uk-slidenav-contrast uk-slidenav-previous uk-hidden-touch" data-lightbox-previous><i class="fa fa-angle-left"></i></a>',
                    '<a href="#" class="uk-slidenav uk-slidenav-contrast uk-slidenav-next uk-hidden-touch" data-lightbox-next><i class="fa fa-angle-right"></i></a>'
                ].join('');
            }
